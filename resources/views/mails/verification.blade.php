                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="padding: 40px 30px 40px 30px;">
                            <h2 style="color: #333333; font-size: 22px; margin-bottom: 20px;">Hello {{ $name }}</h2>
                            ...
                            <p style="color: #666666; font-size: 16px; line-height: 1.6;">
                                You can log in to your account for more details. If you didn't initiate this action, please contact our support immediately.
                            </p>
